...
//  AppStore
//
//  Created by Yujean Cho on 2022/07/23.
//
...
final class FeatureSectionView: UIView {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.scrollDirection = .horizontal // 좌우
        ...
        collectionView.showsHorizontalScrollIndicator = false // Hide scrollBar
    ...
    // UIViewController 라면 viewDidLoad 였겠지만 UIView 이기 때문에
    override init(frame: CGRect) {
        ...
        fetchData()
        collectionView.reloadData() // data 를 가져온 뒤 꼭 reload
    }
